                    ...
                    <div className="block">
                                    ...
                                    {testimonies.data.length > 0
                                        ? testimonies.data.map(
                                            (testimony, index) => (
                                                ...
                                                >
                                                    <td className="px-6 py-4 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">
                                                        {index + 1}
                                                    </td>
                        ...
                        >
                            <ul className="flex items-center justify-center text-sm h-auto gap-12">
                                {/* Tombol Back / First Page */}
                                {testimonies.prev_page_url && (
                                    <li>
                                        <Link
                                            href={testimonies.first_page_url}
                                ...
                                <li>
                                    <ul className="flex items-center justify-center gap-4">
                                        {testimonies.links.map((link, index) => (
                                            <li key={index}>
                                                <Link
                                                    href={
                                                        link.url ||
                                                    ...
                                                    className={`font-normal text-base leading-7 py-2.5 px-4 rounded-full transition-all duration-500 ${link.active
                                ...
                                {/* Tombol Last */}
                                {testimonies.next_page_url && (
                                    <li>
                                        <Link
                                            href={testimonies.last_page_url}
                                            className="flex items-center justify-center gap-2 px-3 h-8 ml-0 text-gray-500 bg-white font-medium text-base leading-7 hover:text-gray-700"
                                        >
                                            Last
                                            <svg
