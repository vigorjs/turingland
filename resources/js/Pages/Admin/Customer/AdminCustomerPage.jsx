...
export default function AdminCustomerPage({ customers }) {
    ...
    const sortedData = [...customers.data].sort((a, b) => {
        if (sortOrder === "asc") {
            return a.id - b.id;
        } else {
            return b.id - a.id;
    ...
    const handleSelectAll = (e) => {
        if (e.target.checked) {
            setSelectAll(true);
            setSelectedCustomer(customers.data.map((customer) => customer.id));
        } else {
            setSelectAll(false);
            setSelectedCustomer([]);
        }
                                    ...
                                    {sortedData
                                        .filter((customer) => {
                                            ...
                                            const customerEmail =
                                                ...
                                                "";
                                            const customerPhone =
                                                customer?.wa_number?.toLowerCase() ??
                                                "";
