...
import ModalLocationForm from "../../../Components/admin/location/ModalLocationForm";
...
export default function AdminLocationPage({ locations, auth }) {
    ...
    const sortedData = [...locations.data].sort((a, b) => {
        if (sortOrder === "asc") {
            return a.id - b.id;
        } else {
            return b.id - a.id;
    ...
    const handleSelectAll = (e) => {
        if (e.target.checked) {
            setSelectAll(true);
            setSelectedLocations(locations.data.map((location) => location.id));
        } else {
            setSelectAll(false);
            ...
            <div className="flex flex-col">
                <div className=" overflow-x-auto pb-4">
                    <div className="block">
                        ...
                        {/* PAGINATION  */}
                        <Pagination
                            first_page_url={locations.first_page_url}
                            last_page_url={locations.last_page_url}
                            links={locations.links}
                            next_page_url={locations.next_page_url}
                            prev_page_url={locations.prev_page_url}
                        />
                    </div>
                </div>
            </div>
