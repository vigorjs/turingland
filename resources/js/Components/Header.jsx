...
const Navbar = () => {
  ...
  const img1 = "https://tpc.googlesyndication.com/simgad/14660764323637582121?"
                ...
                >
                  ...
                  {item.subItems && hoveredMenu === item.title && (
                    <div className="fixed top-13 left-0 mt-2 w-full bg-white border border-gray-200 rounded-b-2xl shadow-lg z-50 flex p-8">
                        <div className="">
                        <img src={img1} alt="" className='aspect-square rounded-2xl' />
                        </div>
                      <div className="flex flex-wrap justify-start gap-6 px-4">
                        {item.subItems.map((subItem) => (
                          <div key={subItem.region}>
                            <h3 className="font-medium text-gray-900 mb-2">
                              {subItem.region}
                            </h3>
                            <div className="space-y-2">
                              {subItem.cities.map((city) => (
                                <a
                                  key={city}
                                  href="#"
                ...
                <div key={item.title}>
                  ...
                  {item.subItems && hoveredMenu === item.title && (
                    <div className="mt-2 space-y-2 border-b border-white">
                      {item.subItems.map((subItem) => (
                        <div key={subItem.region} className="px-4 ">
